...
\subsubsection{\textcolor{darkblue}{Đồ thị có trọng số âm}}
\textit{\textbf{Ví dụ:}} Cho đồ thị vô hướng có trọng số âm, \textbf{có chu trình âm} với:
\begin{itemize}
    \item Số đỉnh (V) : 7
    \item Số cạnh (E) : 12
    \item Danh sách cạnh (u, v, w) : \\
...
\centering
\begin{tabular}{ccccc}
\texttt{1 2 4} & \texttt{1 3 2} & \texttt{1 4 7} & \texttt{2 3 -3} & \texttt{2 5 6} \\
\texttt{3 4 1} & \texttt{3 6 5} & \texttt{4 6 -2} & \texttt{4 7 3} & \texttt{5 6 2} \\
\texttt{5 7 -4} & \texttt{6 7 4} &  &  &  \\
\end{tabular}
\vspace{-5pt}
\caption{Danh sách cạnh}
\end{table}\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Picture/graph3-negative.png}
    \caption{Biểu diễn đồ thị}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Picture/Dij-negative.png}
    \caption{Kết quả thuật toán Dijkstra}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Picture/Bell-negative.png}
    \caption{Kết quả thuật toán Bellman-Ford}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Picture/sosanh-negative.png}
    \caption{Kết quả chức năng so sánh}
    \label{fig:placeholder}
\end{figure}

\subsubsection{\textcolor{darkblue}{Đồ thị có trọng số âm}}
\textit{\textbf{Ví dụ:}} Cho đồ thị có hướng có trọng số âm, \textbf{không có chu trình âm} với:
\begin{itemize}
    \item Số đỉnh (V) : 5
    \item Số cạnh (E) : 9
    \item Danh sách cạnh (u, v, w) : \\
...
\centering
\begin{tabular}{ccccc}
\texttt{4 1 4} & \texttt{4 5 3} & \texttt{4 3 7} & \texttt{1 3 4} & \texttt{3 1 -3} \\
\texttt{1 5 5} & \texttt{5 3 3} & \texttt{5 2 2} & \texttt{2 3 -4} &  \\
\end{tabular}
\vspace{-5pt}
\caption{Danh sách cạnh}
\end{table}\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Picture/graph4-negative.png}
    \caption{Biểu diễn đồ thị}
    \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Picture/Dij2-negative.png}
    \caption{Kết quả thuật toán Dijkstra}
    \label{fig:placeholder}
\end{figure}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Picture/bell1.png}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Picture/bell2.png}
\end{subfigure}
\end{figure}
...
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Picture/bell3.png}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{Picture/bell4.png}
\end{subfigure}
\caption{Minh họa chức năng Bellman-Ford}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Picture/sosanh2.png}
    \caption{Chức năng so sánh}
    \label{fig:placeholder}
\end{figure}
